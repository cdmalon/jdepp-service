...
//  $Id: timer.h 827 2012-05-10 14:12:37Z ynaga $
...
namespace ny {
  ...
  private:
    ...
    std::string  _unit;
  public:
    static const long double clock;
    Timer (const char* p = "timer", const char* u = "trial") : _start (0), _end (0), _elapsed (0), _trial (0), _label (p), _unit (u) {};
    ...
    static long double getCPUClock ();
    long double  getElapsed () const { return ((_elapsed / clock) / 1000); };
    unsigned int getTrial   () const { return _trial; };
